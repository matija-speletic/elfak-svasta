...
data segment
    ...
    ;PRIMER 3: program je napravljen tako da podrazumeva sirinu podataka navedenu u primeru 1, u ovom primeru, sve adrese se izmesaju prilikom izvrsavanja i dobije se netacan rezultat
    p1 dd 12h 
    p2 dd 45abcdh 
    p3 db 7890h
data ends
